...
cd "$BM_HOME_PATH/scripts-linux/uboot"
echo "1. Prepare U-Boot source"
#make -C "$BM_HOME_PATH/scripts-linux/uboot" --no-print-directory -f Makefile-prep-ub.mk release
...
#cp -f -u $UBOOT_OUT_PATH/u-boot/u-boot-with-spl.sfp $BM_HOME_PATH/scripts-linux/Debug/uboot
#cp -f -u $UBOOT_OUT_PATH/u-boot/u-boot-with-spl.sfp $BM_HOME_PATH/scripts-linux/Release/uboot
